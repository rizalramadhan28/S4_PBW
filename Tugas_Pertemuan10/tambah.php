...
$errors = [];
$input  = ['nama_produk' => '', 'kategori' => '', 'harga' => '', 'stok' => '', 'deskripsi' => ''];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!ctype_digit($input['stok']) || $input['stok'] < 0)  $errors[] = 'Stok harus berupa angka bulat positif.';

    if (empty($errors)) {
        // Prepared Statement — INSERT
        $stmt = $pdo->prepare("INSERT INTO produk (nama_produk, kategori, harga, stok, deskripsi) VALUES (?, ?, ?, ?, ?)");
        try {
            $stmt->execute([
                $input['nama_produk'],
                $input['kategori'],
            ...
            $_SESSION['pesan'] = ['tipe' => 'success', 'teks' => 'Produk berhasil ditambahkan!'];
...
<nav class="navbar navbar-dark bg-primary shadow-sm mb-4">
    <div class="container">
        <a class="navbar-brand" href="index.php"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
        <span class="text-white fw-semibold">Tambah Produk Baru</span>
    </div>
</nav>
            ...
            <form method="POST" action="tambah.php" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kategori" class="form-control"
                           value="<?= htmlspecialchars($input['kategori']) ?>"
                           placeholder="Contoh: Elektronik, Aksesoris, Pakaian..." required>
                </div>
                <div class="row">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="3"
                              placeholder="Deskripsi singkat produk (opsional)..."><?= htmlspecialchars($input['deskripsi']) ?></textarea>
                </div>
